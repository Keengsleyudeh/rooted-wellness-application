      ...
      <header className="sticky top-0 z-30 border-b border-soft-sage/30 bg-ivory/85 backdrop-blur-md">
        <div className="container-rw flex h-14 items-center justify-between md:h-16">
          <Link
            ...
            aria-label="Rooted Wellness super admin home"
          >
            Rooted · Super Admin
          </Link>
          <nav
          ...
          >
            <SuperAdminNavLink href="/super-admin/admins">
              Admins
            </SuperAdminNavLink>
            <SuperAdminNavLink href="/super-admin/settings">
              Settings
            </SuperAdminNavLink>
            <SuperAdminNavLink href="/super-admin/audit-logs">
              Audit
            </SuperAdminNavLink>
          </nav>
        </div>
